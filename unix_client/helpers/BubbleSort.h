...
typedef struct
{
    ...
    //arr[ra .... rb]
    int ra, rb;
} indexes; // for tracking the first and last element of an arr.
...
public:
    ...
    // Random Generator
    void rand_arr(arr _A, indexes _a, double _l, double _h);

    // Sorting Algos
    void BubbleSort(arr _A, indexes _a);

    // Sorting (Multithreding)
    void BubbleSort_parallel(arr _A, indexes _a);
    
    // Print Array
    void disply_arr(arr _A, indexes _a, char *name);

};

void SortingAlgo::BubbleSort(arr _A, indexes _a)
{
...
void SortingAlgo::BubbleSort_parallel(arr _A, indexes _a)
{
...
void SortingAlgo::rand_arr(arr _A, indexes _a, double _l, double _h)
{
...
void SortingAlgo::disply_arr(arr _A, indexes _a, char *name)
{
    printf("%s = {\n", name);
    for (i = _a.ra; i < _a.rb; i++)
    {
